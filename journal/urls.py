...
urlpatterns = [
    ...
    # Static Pages
    path('about/', views.dynamic_page, {'slug': 'about'}, name='about'),
    path('about/aim-scope/', views.dynamic_page, {'slug': 'aim-scope'}, name='aim_scope'),
    path('about/editorial-team/', views.dynamic_page, {'slug': 'editorial-team'}, name='editorial_team'),
    path('about/publication-schedule/', views.dynamic_page, {'slug': 'publication-schedule'}, name='publication_schedule'),
    path('about/publication-fees/', views.dynamic_page, {'slug': 'publication-fees'}, name='publication_fees'),
    path('about/contact/', views.dynamic_page, {'slug': 'contact'}, name='contact'),
    path('publications/', views.dynamic_page, {'slug': 'publications'}, name='publications'),
    path('publications/current/', views.current_issue, name='current_issue'),
    path('publications/archives/', views.archives, name='archives'),
    path('indexing/', views.dynamic_page, {'slug': 'indexing'}, name='indexing'),

    path('metrics/', views.dynamic_page, {'slug': 'metrics'}, name='metrics'),
    path('guidelines/', views.dynamic_page, {'slug': 'guidelines'}, name='guidelines'),
    path('guidelines/author/', views.dynamic_page, {'slug': 'author-guidelines'}, name='author_guidelines'),
    path('guidelines/reviewer/', views.dynamic_page, {'slug': 'reviewer-guidelines'}, name='reviewer_guidelines'),
    path('policies/ethics/', views.dynamic_page, {'slug': 'ethics-malpractice'}, name='ethics_malpractice'),
    path('policies/open-access/', views.dynamic_page, {'slug': 'open-access-policy'}, name='open_access_policy'),
    path('policies/editorial/', views.dynamic_page, {'slug': 'editorial-policy'}, name='editorial_policy'),
    path('policies/peer-review/', views.dynamic_page, {'slug': 'peer-review-policy'}, name='peer_review_policy'),
    path('policies/archiving/', views.dynamic_page, {'slug': 'archiving-policy'}, name='archiving_policy'),
    path('policies/subscription/', views.dynamic_page, {'slug': 'subscription-advertising'}, name='subscription_advertising'),
    path('policies/plagiarism/', views.dynamic_page, {'slug': 'plagiarism-policy'}, name='plagiarism_policy'),
    path('policies/', views.dynamic_page, {'slug': 'policies'}, name='policies'),
    path('announcements/', views.announcements, name='announcements'),
    path('announcements/<int:announcement_id>/', views.announcement_detail, name='announcement_detail'),
    path('jhst-journals/', views.dynamic_page, {'slug': 'jhst-journals'}, name='jhst_journals'),
